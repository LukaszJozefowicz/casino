...
public class BlackJackOperationStrategy extends GameOperationsStrategy implements OperationsStrategy{
    public BlackJackOperationStrategy(List<Item> necessaryItems, List<Customer> players) {
